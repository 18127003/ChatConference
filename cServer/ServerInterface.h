...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->backgroundWorker1->DoWork += gcnew System::ComponentModel::DoWorkEventHandler(this, &ServerInterface::backgroundWorker1_DoWork);
			...
			this->btListen->Click += gcnew System::EventHandler(this, &ServerInterface::btListen_Click);
			...
			this->Text = L"Server";
			this->Load += gcnew System::EventHandler(this, &ServerInterface::MainScreen_Load);
			this->ResumeLayout(false);
			this->PerformLayout();
			txtConnected->CheckForIllegalCrossThreadCalls = false;
			txtClientChatBox->CheckForIllegalCrossThreadCalls = false;
			txtClientList->CheckForIllegalCrossThreadCalls = false;
		}
#pragma endregion
