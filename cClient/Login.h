...
#pragma region 
		void InitializeComponent(void)
		{
			...
			this->butLogin->Click += gcnew System::EventHandler(this, &Login::butLogin_Click);
			...
			this->butSignup->Click += gcnew System::EventHandler(this, &Login::butSignup_Click);
			...
			this->PerformLayout();
			txtPassword->CheckForIllegalCrossThreadCalls = false;
			txtUsername->CheckForIllegalCrossThreadCalls = false;
