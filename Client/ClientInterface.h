...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Click += gcnew System::EventHandler(this, &ClientInterface::label1_Click);
			...
			this->butSend->Click += gcnew System::EventHandler(this, &ClientInterface::butSend_Click);
			...
			this->labName->Click += gcnew System::EventHandler(this, &ClientInterface::label3_Click);
			...
			this->butDisconnect->Click += gcnew System::EventHandler(this, &ClientInterface::butDisconnect_Click);
			...
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &ClientInterface::MainScreen_FormClosing);
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &ClientInterface::MainScreen_FormClosed);
			this->Load += gcnew System::EventHandler(this, &ClientInterface::MainScreen_Load);
