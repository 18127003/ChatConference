...
namespace MyClient {
	...
	public ref class PrivateChannel : public System::Windows::Forms::Form
	{
	public:
		PrivateChannel(void)
		{
...
#pragma region 
		void InitializeComponent(void)
		{
			...
			this->butSend->Click += gcnew System::EventHandler(this, &PrivateChannel::butSend_Click);
			...
			this->butFile->Click += gcnew System::EventHandler(this, &PrivateChannel::butFile_Click);
			...
			this->labPath->Click += gcnew System::EventHandler(this, &PrivateChannel::label1_Click_2);
			...
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &PrivateChannel::PrivateChat_FormClosing);
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &PrivateChannel::PrivateChat_FormClosed);
			this->Load += gcnew System::EventHandler(this, &PrivateChannel::PrivateChat_Load);
...
{
public:
	MyClient::PrivateChannel^ privateChatForm;
	System::String^ strUsername;

	PrivateChatInfo(MyClient::PrivateChannel^ _privateChatForm, System::String^ _strUsername) :
